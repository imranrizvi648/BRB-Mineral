      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-7 md:mt-16 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
             BRB Exploration stands at the forefront of mineral exploration and extraction, meeting the growing global demand for high-quality minerals and metals. Our operations include exploration, resource assessment, extraction, and supply of placer gold and heavy black sand.
            </motion.p>
            <motion.p
              className="text-gray-700 text-base md:text-lg leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
...
>
  ...
  <div className="text-center md:text-left -mt-5">
    ...
    <p className="text-gray-700">To be a leading mineral exploration company recognized for excellence, integrity, and environmental stewardship. To be a global leader in the mineral and metal industry, recognized for operational excellence and environmental stewardship.
    </p>
  </div>
</motion.div>
