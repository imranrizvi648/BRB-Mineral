...
export default function AntimonyHero() {
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
            <span className="bg-gradient-to-r from-[#03A2A7] to-[#0c3c52] bg-clip-text text-transparent">
              Antimony in Pakistan
            </span>
            <br />
            <span className="text-gray-800 text-xl ">
              A Strategic Metalloid with Growing Industrial Importance
            </span>
          </h1>

          <p className="text-gray-700 text-base sm:text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
            BRB Exploration is actively developing and evaluating
            antimony-bearing deposits across Pakistan, where geological surveys
            indicate strong potential for stibnite-rich mineralization. As
            global demand rises for flame retardants, specialty alloys,
            batteries, and advanced industrial materials, antimony stands out as
            a strategic opportunity for Pakistan’s mining and export sector
          </p>
