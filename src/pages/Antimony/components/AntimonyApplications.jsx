...
export default function AntinomyApplications() {
   const applications = [
    { icon: <BarChart className="w-6 h-6" />, text: "Flame retardant manufacturing" },
    { icon: <Gem className="w-6 h-6" />, text: "Lead hardening and specialty alloys" },
    { icon: <Cpu className="w-6 h-6" />, text: "Battery and energy storage technologies" },
    { icon: <Globe className="w-6 h-6" />, text: "Ceramics, glass, and pigments" },
    { icon: <Factory className="w-6 h-6" />, text: "Semiconductor and advanced industrial components" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         ...
         <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold   relative inline-block">
           ...
           <p className="text-lg text-gray-600 mt-8 max-w-3xl mx-auto">
              Antimony is essential to industrial technologies and modern material applications.
            </p>
          </motion.div>
