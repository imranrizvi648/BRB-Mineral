...
export default function AntinomyProducts() {
  const products = [
    "High-grade antimony ore and stibnite concentrates sourced from Pakistan’s mineral belts",
    "Verified Sb content, documented through certified assays and mineral analysis",
    "Ethically and legally sourced material, compliant with Pakistan’s mining and environmental regulations",
    "Bulk and tailored supply options for processors, refiners, and industrial users",
  ]
   ...
   <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            Each shipment offers consistent quality and traceable origin. BRB Exploration provides:
              </p>
