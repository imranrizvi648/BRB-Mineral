      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center md:max-w-[91%] mx-auto relative z-10">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
            ...
            <br />
            <span className="text-gray-800 text-xl ">Strategic Industrial Metal from World-Class Mineral Belts</span>
          </h1>

          <p className="text-gray-700 text-base sm:text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
           BRB Exploration is developing and evaluating copper-rich deposits
            across Pakistan, a country recognized for its high-potential
             porphyry copper systems and polymetallic mineral zones. As global
             demand grows for copper in renewable energy, power infrastructure,
             electric vehicles, and advanced manufacturing, Pakistan stands as one of
             the most promising regions for copper exploration and production.
          </p>
...
//         style={{
//           backgroundImage:
//             "url(https://images.unsplash.com/photo-1567932672494-42fa5d0f5b2d?w=1600&q=80)",
//           backgroundSize: "cover",
//           backgroundPosition: "center",
//           backgroundAttachment: "fixed",
//         }}
//       >
//         <div className="absolute inset-0 bg-linear-to-b from-black/80 via-black/65 to-black/80"></div>
