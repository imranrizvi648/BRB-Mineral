      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center md:max-w-[91%] mx-auto relative z-10">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
            <span className="bg-gradient-to-r from-[#03A2A7] to-[#0c3c52] bg-clip-text text-transparent">
              Black Sand in Pakistan
            </span>
           
          </h1>

          <p className="text-gray-700 text-base sm:text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
             BRB Exploration supplies high-quality black sand concentrates from
            selected rivers and mineral-rich terrains across Pakistan. Known for
            containing magnetite, ilmenite, hematite, and occasionally fine
            placer gold, black sand serves as a valuable material for
            prospectors, refiners, researchers, and industrial users.
          </p>
        ...
        <div className="flex justify-center md:justify-end relative">
          ...
          <div className="relative">
            ...
            <img
              src="/brbExploration/blackSand/2nd image (1).webp"
