...
export default function BariteBenefitsSection() {
  ...
  return (
    ...
    >
      ...
      <p
        ...
        `}
      >
        Currently, barite mining in Pakistan is carried out on a limited scale,
        with significant opportunities for expansion. By investing in modern
        mining technology, processing facilities, and quality control, Pakistan
        can:
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-10">
        ...
        <div
          className={`
            bg-white p-4 sm:p-5 md:p-6 rounded-xl shadow-md 
            flex items-start gap-3 sm:col-span-2 md:col-span-1
            transition-all duration-700 ease-out hover:shadow-xl hover:scale-105
            ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-16"}
          `}
