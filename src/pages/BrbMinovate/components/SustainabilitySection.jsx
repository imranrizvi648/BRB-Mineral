  ...
  const cardData = [
    {
      ...
      text: "Eco-friendly placer mining: reduce land disturbance, water management, reclaim riverbanks, minimize emissions.",
    },
    {
      title: "Community Engagement",
      text: "Jobs, local development, and responsible land use in placer mining regions.",
    },
    {
      title: "Ethical Mining Standards",
      text: "Full compliance with local & international regulations, especially for alluvial mining.",
    },
  ];
