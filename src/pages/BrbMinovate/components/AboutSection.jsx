      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-7 md:mt-16 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
        BRB Minovate is an innovative technology solutions company operating under the umbrella of BRB Group, serving multiple industries           </motion.p>
            <motion.p
              className="text-gray-700 text-base md:text-lg leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
           We specialize in creating smart digital solutions using modern technologies and ethical practices to deliver reliable, high-quality services for local and international markets.
            </motion.p>
 ...
 {/* Text Block */}
  <div className="text-center md:text-left -mt-5">
                ...
                <p className="text-gray-700">
                  To responsibly explore, develop, and supply placer gold resources that contribute to industrial growth and sustainable development.
                </p>
                  </div>
              </motion.div>
...
>
  ...
  <div className="text-center md:text-left -mt-5">
    ...
    <p className="text-gray-700">To be a leading placer gold exploration & mining company, recognized for excellence, integrity, and environmental stewardship in alluvial mining.
    </p>
  </div>
</motion.div>
...
{coreValues.map((item, i) => (
    <motion.div
      key={item.label}
      className="text-center p-6 bg-white rounded-xl shadow-md hover:shadow-xl hover:-translate-y-2 transition-all flex flex-col items-center justify-center"
      initial={{ opacity: 0, y: 20 }}
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true }}
    ...
    >
      <img
        src={item.icon}
        alt={item.label}
        className="w-20 h-20 md:h-24 md:w-24 mx-auto mb-4 object-contain"
      />
