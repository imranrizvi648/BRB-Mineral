      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-5 items-center max-w-7xl mx-auto">
        ...
        >
          <h2
            ...
            "
          >
            <span className="text-[#03A2A7]">BRB </span> Minovate
          </h2>
          ...
          <p
            ...
            "
          >
             BRB Minovate is a mineral and mining company focused exclusively on unlocking the value of placer gold deposits through innovation, responsibility, and long-term sustainability. With advanced geological expertise in alluvial systems and ethical mining practices, we deliver high-quality gold to global markets.
          </p>
