          ...
          >
            {applications.map((app, index) => (
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="bg-white shadow-sm rounded-xl  sm:p-6 md:p-6 border border-gray-200 hover:border-[#03A2A7] transition-colors duration-300 group cursor-pointer flex items-center gap-4"
              >
                {/* Image on left */}
                <motion.img
                  src={images[index]}
                  alt={app}
                  className="w-17 h-17  md:w-20 md:h-20 object-cover rounded-full"
