      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center md:max-w-[91%] mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-700 text-base sm:text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
             BRB Exploration is actively identifying and developing placer gold
            resources across Pakistan, where river systems and alluvial plains
            carry naturally concentrated gold particles. With rising global
            demand for responsibly sourced gold, Pakistan's placer gold
            potential offers a sustainable, high-value opportunity for both
        ...
        <div className="flex justify-center md:justify-end relative">
          ...
          <div className="relative">
            ...
            <img
              src="/brbExploration/placerGold/sideImage.webp"
