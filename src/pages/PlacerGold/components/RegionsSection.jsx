  ...
  return (
    <div className="bg-linear-to-br from-gray-50 to-blue-50 py-12 sm:py-14 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        {/* Heading */}
        <h2 className="text-3xl md:text-5xl font-bold text-center mb-5 text-gray-900">
          <span className="text-[#03A2A7]">Placer Gold in </span> Pakistan
        </h2>

        <p className="text-center text-gray-700 text-base md:text-lg max-w-3xl mx-auto mb-10 md:mb-12">
          Placer gold forms when natural weathering releases gold from hard-rock
          deposits, allowing rivers and streams to transport and concentrate it
          in alluvial sediments. Pakistan hosts several promising placer gold
          zones, including:
        </p>
