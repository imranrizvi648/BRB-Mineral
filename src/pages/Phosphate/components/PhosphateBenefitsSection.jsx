...
export default function PhosphateBenefitsSection() {
  ...
  return (
    ...
    >
      ...
      <p
        ...
        `}
      >
        Currently, much of Pakistan’s fluorite is extracted using traditional
        mining methods, which often result in wastage and lower-quality yields.
        By adopting modern mining techniques, advanced processing technologies,
        and international best practices, the country can:
      </p>
