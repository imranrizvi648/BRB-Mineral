      ...
      >
        ...
        >
          <h1
            ...
            "
          >
            Phosphate in Pakistan – <br />
            <span className="text-gray-800">
             Fueling Agriculture and Economic Growth
            </span>
          </h1>
          ...
          <p
            ...
            "
          >
              Phosphate is one of the most important minerals for agriculture and
              food security, serving as a key ingredient in fertilizers that
              support healthy crop growth. Pakistan is rich in phosphate reserves,
              particularly in Khyber Pakhtunkhwa and Balochistan, making it a
            valuable resource for national development.
          </p>
        </div>
        ...
        <div className="flex justify-center md:justify-end relative md:mt-3">
          ...
          <div className="relative">
            <img
              src="/phosphatePage/Posphate.webp"
              alt="Fluorite Visual"
              className={`
