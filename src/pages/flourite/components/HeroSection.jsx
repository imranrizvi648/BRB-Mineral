      ...
      >
        ...
        >
          <h1
            ...
            "
          >
            Fluorite in Pakistan – <br />
            <span className="text-gray-800">
              A Hidden Treasure with Global Potential
            </span>
          </h1>
          ...
          <p
            ...
            "
          >
            Fluorite, also known as fluorspar, is one of the most significant
            industrial minerals found in Pakistan. Rich deposits of this
            valuable resource are located in Balochistan and Khyber Pakhtunkhwa,
            making Pakistan a promising hub for fluorite production.
          </p>
        </div>
        ...
        <div className="flex justify-center md:justify-end relative md:mt-3">
          ...
          <div className="relative">
            <img
              src="/flouritePage/Flourite (1).webp"
              alt="Fluorite Visual"
              className={`
