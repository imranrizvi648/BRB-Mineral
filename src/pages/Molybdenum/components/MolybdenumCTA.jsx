...
export default function MolybdenumCTA() {
  return (
      ...
      style={{
        backgroundImage:
          "url('/molybdenum/lastbanner.webp')",
    ...
    >
      ...
      >
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold   mb-6 leading-10 md:leading-16">
            Advancing Pakistan’s  <span className="text-[#03A2A7]"> High-Value Metals Sector</span>
          </h2>
          <p className=" text-base sm:text-lg md:text-lg text-gray-200 mb-8 leading-relaxed">
          Molybdenum is essential for modern engineering and industrial durability. BRB Exploration is committed to unlocking Pakistan’s molybdenum potential, delivering high-quality, responsibly sourced materials that support national development and global manufacturing.
          </p>
