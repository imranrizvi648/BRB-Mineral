...
export default function MolybdenumHero() {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-centermd:max-w-[91%] mx-auto relative z-10">
        {/* LEFT SIDE TEXT */}
        <div
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
            <span className="bg-gradient-to-r from-[#03A2A7] to-[#0c3c52] bg-clip-text text-transparent">
             Molybdenum in Pakistan
            </span>
            <br />
            <span className="text-gray-800 text-xl ">
              High-Strength Metal from Promising Mineral Zones
            </span>
          </h1>

          <p className="text-gray-700 text-base sm:text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
            BRB Exploration is actively surveying and developing
            molybdenum-bearing deposits across Pakistan, a country with
            significant potential for high-value industrial metals. With
            increasing global demand for durable alloys, aerospace-grade
            materials, and energy infrastructure components, molybdenum stands
            out as a strategic metal for Pakistan’s growing mining sector
          </p>
