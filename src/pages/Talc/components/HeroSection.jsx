      ...
      >
        ...
        >
          <h1
            ...
            "
          >
            Talc (Soapstone) In Pakistan – <br />
            <span className="text-gray-800">
            A World-Class Industrial Mineral
            </span>
          </h1>
          ...
          <p
            ...
            "
          >
          /   Pakistan is home to some of the world’s finest-quality talc
   deposits, particularly in Khyber Pakhtunkhwa (KPK). Known for
   their exceptional purity, bright white color, and asbestos-free
   properties, these reserves are among the most sought-after
   globally. With a favorable mineral composition (MgO &gt; 30% and
  Fe &lt; 0.1%), Pakistan’s talc is ideally suited for use in
   high-value industries, creating strong opportunities for both
  local utilization and export.
          </p>
        </div>
        ...
        <div className="flex justify-center md:justify-end relative md:mt-3">
          ...
          <div className="relative">
            <img
                src="/TalcPage/Talc soapstone.webp"
              alt="Fluorite Visual"
              className={`
