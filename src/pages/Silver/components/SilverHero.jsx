...
export default function SilverPage() {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center relative md:max-w-[91%] mx-auto z-10">
        {/* LEFT SIDE TEXT */}
        <div
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
            ...
            <span className="text-gray-800 text-xl ">
              High-Potential Precious Metal from Emerging Mineral Zones
            </span>
          </h1>

          <p className="text-gray-700 text-base sm:text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
            BRB Exploration is actively developing silver-rich deposits across
            Pakistan, a country with promising geological conditions for
            precious and base-metal mineralization. With silver playing an
            increasingly vital role in electronics, renewable energy, jewelry,
            and industrial applications, Pakistan’s silver potential presents
            strong opportunities for growth and international supply
          </p>
