        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
            ...
            <span className="text-gray-800 text-xl ">
              Premium Precious Metal from Promising Geological Regions
            </span>
          </h1>

          <p className="text-gray-700 text-base sm:text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
            BRB Exploration is developing high-potential gold resources across
            Pakistan, where diverse geological environments offer opportunities
            for both placer and hard-rock gold discoveries. With rising global
            demand for responsibly sourced precious metals, Pakistan’s gold
            sector holds strong potential for growth, investment, and
            international trade
          </p>
