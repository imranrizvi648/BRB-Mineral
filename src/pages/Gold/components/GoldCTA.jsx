    ...
    >
      ...
      >
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold   mb-6 leading-14">
            Unlocking Pakistan’s <span className="text-[#03A2A7]"> Golden Opportunity</span>
          </h2>
         <p className=" text-base sm:text-lg md:text-lg text-gray-200 mb-8 leading-relaxed">
          Gold remains a symbol of value, security, and innovation. BRB Exploration is committed to developing Pakistan’s gold resources responsibly—supporting national economic growth while delivering high-quality, dependable gold materials to global markets.
          </p>
