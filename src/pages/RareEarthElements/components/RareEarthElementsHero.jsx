...
export default function MolybdenumHero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-30">
        ...
        <div
          className="absolute bottom-20 left-[15%] w-24 h-24 border-3 border-[#03A2A7] rotate-12"
          style={{
            clipPath:
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-[20%] left-[30%] w-2 h-2 bg-[#03A2A7] rounded-full animate-bounce"
          style={{ animationDuration: "3s", animationDelay: "0s" }}
        ></div>
        <div
          className="absolute top-[40%] left-[60%] w-3 h-3 bg-[#0c3c52] rounded-full animate-bounce"
          style={{ animationDuration: "4s", animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-[60%] left-[20%] w-2 h-2 bg-[#03A2A7] rounded-full animate-bounce"
          style={{ animationDuration: "3.5s", animationDelay: "0.5s" }}
        ></div>
        <div
          className="absolute top-[30%] right-[25%] w-2 h-2 bg-[#03A2A7] rounded-full animate-bounce"
          style={{ animationDuration: "4.5s", animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-[30%] right-[40%] w-3 h-3 bg-[#0c3c52] rounded-full animate-bounce"
      ...
      <div className="absolute inset-0 pointer-events-none opacity-5">
        <div
          ...
          style={{
            backgroundImage:
              "repeating-linear-gradient(45deg, #03A2A7 0px, #03A2A7 2px, transparent 2px, transparent 40px)",
          }}
        ></div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center md:max-w-[91%] mx-auto relative z-10">
        {/* LEFT SIDE TEXT */}
        <div
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
            <span className="bg-gradient-to-r from-[#03A2A7] to-[#0c3c52] bg-clip-text text-transparent">
              Rare Earth Elements in Pakistan
            </span>
            <br />
            <span className="text-gray-800 text-xl ">
              Strategic Minerals from a Geologically Promising Region
            </span>
          </h1>

          <p className="text-gray-700 text-base sm:text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
            BRB Exploration is actively engaged in identifying and developing
            rare earth element (REE) resources within Pakistan’s diverse and
            mineral-rich geological landscape. With rising global demand for
            clean energy, high-performance electronics, and advanced
            manufacturing, Pakistan’s REE potential positions the country as an
            emerging contributor to the world’s critical mineral supply chain
          </p>
        ...
        <div className="flex justify-center md:justify-end relative">
          ...
          <div
            className="absolute -top-4 -right-4 w-20 h-20 border-4 border-[#03A2A7] rounded-full opacity-30 animate-spin"
          ...
          <div className="relative">
            ...
            <img
              src="/RareEarthElements/product.webp"
