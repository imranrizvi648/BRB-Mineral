...
import BrbMinovatePage from "../pages/BrbMinovate/brbminovatepage";
    ...
    <BrowserRouter>
      ...
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          //BRB Mineral and Metal
          <Route
            path="/brb-mineral-and-metal"
            element={<BrbMineralAndMetalpage />}
          />
          <Route
            path="/brb-mineral-and-metal/copper"
            element={<CopperPage />}
          />
          <Route
            path="/brb-mineral-and-metal/leadzinc"
            element={<LeadZincPage />}
          />
          <Route
            path="/brb-mineral-and-metal/silver"
            element={<SilverPage />}
          />
          <Route path="/brb-mineral-and-metal/gold" element={<GoldPage />} />
          <Route
            path="/brb-mineral-and-metal/antimony"
            element={<AntimonyPage />}
          />
          <Route
            path="/brb-mineral-and-metal/molybdenum"
            element={<MolybdenumPage />}
          />
          <Route
            path="/brb-mineral-and-metal/rare-earth-elements"
            element={<RareEarthElementsPage />}
          />

          //BRB Minovate
          <Route path="/brb-minovate" element={<BrbMinovatePage />} />
        </Route>
      </Routes>
    </BrowserRouter>
  );
